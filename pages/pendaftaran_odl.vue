        ...
        <v-form v-model="valid" @submit.prevent="handleCreateData">
          <v-card-text style="margin-top: -30px">
            ...
            <v-row v-if="step == 1">
              ...
              <v-col cols="12" v-if="diskonAppliedMessage != null" class="mt-2">
...
async function handleCreateData() {
  ...
  try {
    ...
    if (
      ...
      show.value = true;
      message.value = "Harap isi form dengan lengkap";
    } else if (step.value == 6 && form.value.bukti_transaksi == null) {
      show.value = true;
